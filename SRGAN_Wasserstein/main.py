...
from pretrain.nets.resnet_v1 import resnet_v1_50
...
def train():
    ...
    net_g = SRGAN_g(t_image, siamese_res, reuse=False)
    net_d, logits_real ,sigmoid_out_real= SRGAN_d(t_target_image, , reuse=False)
    _,     logits_fake ,sigmoid_out_fake= SRGAN_d(net_g.outputs, siamese_res, reuse=True)
